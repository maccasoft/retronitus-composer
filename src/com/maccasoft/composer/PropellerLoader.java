...
public class PropellerLoader {
    ...
    public void upload(File binaryFile, int type) throws SerialPortException, IOException {
        if (!serialPort.isOpened()) {
            serialPort.openPort();
        }
    ...
    protected void fileUpload(File binaryFile, int type) throws SerialPortException, IOException {
